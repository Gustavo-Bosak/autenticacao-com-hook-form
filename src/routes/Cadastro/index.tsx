        ...
        <fieldset>
          <div>
            <div className='input-container'>
              <label htmlFor='idNomeCompleto'>NomeCompleto</label>
              <input
                type='text'
                name='nomeCompleto'
                id='idNomeCompleto'
            ...
            <div className='input-container'>
              <label htmlFor='idRf'>Rf (Registro_Funcionario)</label>
              <input type='text' name='Rf' id='idRf' required />
            </div>
          </div>
          <div>
            <div className='input-container'>
              <label htmlFor='idCargo'>Cargo</label>
              <input type='text' name='Cargo' id='idCargo' required />
            </div>
            <div className='input-container'>
              <label htmlFor='idSetor'>Setor</label>
              <input type='text' name='Setor' id='idSetor' />
            </div>
          </div>
          <div>
            <div className='input-container'>
              <label htmlFor='idCpf'>CPF</label>
              <input type='text' name='Cpf' id='idCpf' required />
            </div>
            <div className='input-container'>
          ...
          <div>
            <div className='input-container'>
              <label htmlFor='idEmailCorporativo'>Email Corporativo</label>
              <input
                type='email'
            ...
            <div className='input-container'>
              ...
              <input type='number' name='salário' id='idSalario' required />
            </div>
          </div>
          <div>
